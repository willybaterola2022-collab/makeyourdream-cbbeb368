    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex items-center justify-center gap-2 mb-8">
          {(["welcome", "record", "analyzing", "result"] as Step[]).map(
            (s, i) => {
              ...
              return (
                <motion.div
                  ...
                  className={`h-2 rounded-full transition-all duration-500 ${
                    i <= stepIndex ? "gold-gradient" : "bg-muted"
                  }`}
        ...
        <AnimatePresence mode="wait">
          ...
          {step === "welcome" && (
            ...
            >
              ...
              <h1 className="font-serif text-3xl font-bold text-foreground mb-3">
                Bienvenido a
                <br />
                <span className="gold-text">MakeYourDream</span>
              </h1>
              <p className="text-muted-foreground mb-8 leading-relaxed">
                Vamos a descubrir tu voz única. Graba un fragmento cantando y
                nuestra IA analizará tu perfil vocal en segundos.
              </p>

              <div className="space-y-3">
                {[
                  "Canta al menos 10 segundos",
                  "Busca un lugar tranquilo",
                  "Canta como te salga, sin miedo",
                ].map((tip, i) => (
                  <motion.div
                    key={tip}
              ...
              <motion.button
                ...
                className="mt-8 h-14 px-8 rounded-xl gold-gradient text-primary-foreground font-semibold text-lg flex items-center gap-3 mx-auto"
              >
                Estoy listo
            ...
            >
              ...
              <p className="text-muted-foreground text-sm mb-8">
                {isRecording
                  ...
                  : "Pulsa el micrófono y canta al menos 10 segundos"}
              </p>
              ...
              <div className="relative inline-block">
                {isRecording && (
                  <motion.div
                    ...
                    animate={{
                      boxShadow: [
                        "0 0 0 0px hsl(46 65% 52% / 0.4)",
                        "0 0 0 30px hsl(46 65% 52% / 0)",
                      ],
                    }}
              ...
              {/* Timer */}
              <motion.p
                className="mt-6 text-3xl font-serif font-bold text-foreground"
              ...
              {isRecording && recordTime >= 5 && (
                <motion.button
                  ...
                  className="mt-6 h-12 px-6 rounded-xl glass-card text-foreground font-medium"
                >
                  Terminar grabación
                </motion.button>
              )}
          ...
          {step === "analyzing" && (
            ...
            >
              <motion.div
                ...
                className="h-20 w-20 rounded-full border-4 border-muted border-t-primary mx-auto mb-8"
              />
              ...
              <div className="space-y-3 mt-8 text-left">
                {[
                  ...
                  <motion.div
                    ...
                    initial={{ opacity: 0.3 }}
                    animate={{
                      opacity: analyzeProgress > item.threshold ? 1 : 0.3,
                    }}
                    className="glass-card p-3 flex items-center gap-3"
                  >
                    <motion.div
                      className={`h-6 w-6 rounded-full flex items-center justify-center shrink-0 ${
                        analyzeProgress > item.threshold
                          ? "gold-gradient"
                          : "bg-muted"
                      }`}
                      animate={
          ...
          {step === "result" && (
            ...
            >
              ...
              >
                <p className="text-[11px] text-primary uppercase tracking-[0.3em] mb-1">
                  Tu clasificación vocal
                </p>
                <h2 className="font-serif text-3xl font-bold gold-text mb-1">
                  Mezzosoprano Lírica
                </h2>
              ...
              <motion.div
                ...
                className="mt-6 glass-card p-4 border-primary/20"
              >
                <p className="text-sm text-foreground mb-1">
                  <span className="gold-text font-semibold">Suenas a Adele</span> — 87% de similitud
                </p>
                <p className="text-xs text-muted-foreground">
                  Timbre cálido con gran control de registro medio
                </p>
              </motion.div>
              ...
              >
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() => navigate("/")}
                  className="w-full h-14 rounded-xl gold-gradient text-primary-foreground font-semibold text-lg flex items-center justify-center gap-2"
                >
